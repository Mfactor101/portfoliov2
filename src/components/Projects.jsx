    ...
    <>
      <div id="Projects" className="grid place-items-center">
          <div className="p-4 max-w-8xl grid gap-6 sm:grid-cols-2 md:grid-cols-3">
              ...
              {/* First project */}
              <div className="project-card h-32 rounded-lg md:h-auto p-4 bg-cover bg-[url('./img/git-finder.png')]">
              ...
              {/* Fourth project */}
              <div className="project-card h-32 bg-cover bg-[url('./img/webflow.png')] rounded-lg bg-blue-500 sm:h-auto sm:square p-4">
                <div className="container">
                  <p className="my-2"><span className="px-2 rounded-md bg-secondary">Template</span></p>
                  <h1 className="lg:text-3xl text-lg">Webflow Project Template</h1>
                </div>
              </div>
              {/* Call to action */}
              <p className="md:col-span-2 self-center"><span className="attention-animate">Have a question?</span> Contact me for any project related queries <span className="attention-animate">here.</span> </p>
          </div>
      </div>
    </>
  )
